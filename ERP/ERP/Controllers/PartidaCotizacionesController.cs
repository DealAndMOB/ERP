...
{
    public class PartidaCotizacionesController : ApiController
    {
        ...
        [HttpPost]
        public bool AgregarPartidas(List<clsPartidaCotizacionVenta> partidas)
        {
            ...
            string FolioEncontrado = bd.PartidaCotizacionVenta.Where(c => c.Folio == folio).Select(c => c.Folio).FirstOrDefault();
            ...
            {
                bd.PartidaCotizacionVenta.Add(Subiendo);
            }
        ...
        [HttpPut]
        public bool ActualizarCotizacionCompleta(List<clsPartidaCotizacionVenta> partidas)
        {
            JSONwt usuarioJwt = JsonConvert.DeserializeObject<JSONwt>(Request.Properties["payload"].ToString());
        ...
        public bool BorrarPartidas(List<int> partidasID)
        {
            ...
            try
            {
                ...
                {
                    clsPartidaCotizacionVenta partida = bd.PartidaCotizacionVenta.Find(id);
